...
--[[
   Blacklisted vehicles list.
   Add vehicle hashcode to list to prevent them from being driven by civilians

   Dont know the hashcode of the vehicle? See line 48 > 53.
]]
...
-- Prevent car on blacklist from being driven.
...
-- Remove all players weapons when exting any blacklisted vehicle.
Citizen.CreateThread(function()
 while true do
	 Citizen.Wait(0)
